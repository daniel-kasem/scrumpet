...
function dragElement(pageElement) {
  ...
  //touch screen
  document.getElementById(pageElement.id + "_dragThis").addEventListener("touchstart", startDragging);
...
function addNewListeners(pageElement) {
  document.getElementById(pageElement.id + '_dragThis').addEventListener('mousedown', function (e) {
    mouseDown(e, pageElement)
  }, false);
